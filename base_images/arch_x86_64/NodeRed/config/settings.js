...
module.exports = {
    ...
    adminAuth: {
        ...
        users: [
            {
            username: "Node-Red",
            password: "$2a$08$iYU/RY5Yykbvd9E16QyLn.CqE5nmi9ocBhfdKXIAIm0uExsQ9Og5K",
            permissions: "*"
            }
        ]
    },
    ...
    editorTheme: {
        /* page: {
            title: " Edit the World - NodeRed",
            favicon: "/usr/src/app/assets/favicon.ico",
            css: "/usr/src/app/styling/custom.css",
        ...
        menu: { // Hide unwanted menu items by id. see editor/js/main.js:loadEditor for complete list
            ...
            "menu-item-help": {
                label: "get help from me",
                url: "redirectURL"
            }
        },
        //userMenu: false, // Hide the user-menu even if adminAuth is enabled
        login: {
            image: "absolote path" // a 256x256 image
        },
        logout: {
            redirect: "yourUrlHere" // As of 0.17
        }, */
        //palette: {
